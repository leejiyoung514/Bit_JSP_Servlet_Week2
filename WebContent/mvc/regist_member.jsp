...
<script type="text/javascript">
	...
	function id_check_with_ajax(val) {
		...
		alert(cmd);
		//var server_page = "./mvc/id_service.jsp?cmd="+cmd;
	...
	function final_check() {
		...
		var val2 = doucument.getElementById("isZipCheck").value;

		if (varl1 == "true" && val2 == "true") {
			flag = true;
		}
		alert(flag);
		return flag;
		...
		<table>
			<tr>
				...
				<td><input type="text" name="id" id="userid"
					value="<%=vo.getId()%>" readonly="readonly" onclick="id_check()">
					<input type="text" name="" id="message" disabled="disabled">
				</td>
				<td><button onclick="return id_check_with_ajax(0)">id
						check</button></td>
			...
			<tr>
				...
				<td><input type="text" name="name" id="name"
					value="<%=vo.getName()%>"><span id="msg"><%=message%></span></td>
				<td></td>
				<td></td>
			</tr>
			<tr>
				...
				<td><input type="text" name="zip1" size="3"
					value="<%=vo.getZipcode().split("-")[0]%>" id="zip1"> - <input
					type="text" name="zip2" size="3"
					value="<%=vo.getZipcode().split("-")[1]%>" id="zip2"> <span
					id="zipmsg"></span></td>
				<td><button onclick="return id_check_with_ajax(1)">우편번호검사</button></td>
				<td><input type="hidden" name="isZipCheck" value="false"
					id="isZipCheck"></td>
			</tr>
			<tr>
				<td>주소1</td>
			...
			<tr>
				...
				<td><button onclick="return select_check()">select 체크</button></td>
				<td></td>
			</tr>
			<tr>
